...
<template>
  ...
  >
    <NuxtLink
      ...
      class="min-w-[6rem] md:min-w-[10rem] lg:w-1/8 h-[2.5rem] md:h-[3rem] bg-[#F8F9FA] rounded-sm border-1 border-[#373539] flex items-center justify-center text-secondary hover:cursor-pointer hover:bg-[#DEE2E6] active:bg-[#DEE2E6] transition-colors duration-200 ease-in-out"
    >
      SHIRTS
    </NuxtLink>
    <NuxtLink
