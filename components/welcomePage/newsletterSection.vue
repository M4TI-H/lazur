  ...
  <section class="w-full h-[36rem] flex flex-col items-center justify-center">
    ...
    >
      <div class="flex flex-col text-center">
        <h2 class="text-light text-2xl md:text-4xl font-semibold mb-2">
          Join our newsletter
        </h2>
        <p class="text-light whitespace-nowrap">
          Subscribe to get updates on our latest
          <br class="block md:hidden" />
          collections, exclusive offers, and style tips.
        </p>
      </div>
      <div class="w-full max-w-[18rem] flex flex-col items-center gap-8">
        <input
          type="text"
          placeholder="Enter your email"
          class="w-full md:w-[24rem] h-[3rem] bg-[#1F1D20]/50 backdrop-blur-sm focus:bg-[#1F1D20]/60 focus:backdrop-blur-md placeholder-[#CED4DA] placeholder:font-thin text-light rounded-full px-4 border border-[#DEE2E6] outline-none transition duration-500 ease-in-out"
        />
        <button
