...
<template>
  <form class="wfull flex flex-col gap-4 p-4 rounded-lg bg-[#eee]">
    ...
    <div class="flex items-center justify-between pr-4">
      ...
      <!-- <StarReview v-model="rating" :value="rating" /> -->
    </div>
    <textarea
    ...
    <button
      class="max-w-[12rem] w-full h-[2.5rem] bg-[#8088a3] text-secondary rounded-md self-end"
    >
      Confirm
    </button>
    <button
